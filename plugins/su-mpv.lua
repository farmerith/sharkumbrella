...
local function last_ten_seconds()
    last_n_seconds(10)
...
local function last_thirty_seconds()
    last_n_seconds(30)
    mp.osd_message('-30s', 1)
end

local function last_sixty_seconds()
    last_n_seconds(60)
    mp.osd_message('-60s', 1)
end
...
mp.add_key_binding('S', 'set-end', set_end_time)
...
mp.add_key_binding('q', 'clip', clip)
mp.add_key_binding('z', 'bleep', bleep)

mp.add_key_binding('b', 'last-ten-seconds', last_ten_seconds)
mp.add_key_binding('g', 'last-thirty-seconds', last_thirty_seconds)
mp.add_key_binding('v', 'last-sixty-seconds', last_sixty_seconds)
